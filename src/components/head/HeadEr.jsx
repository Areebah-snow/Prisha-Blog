...
import HeroImg from "./../../images/img8.jpg";

const HeadEr = () => {
  return (
    // header
    <div className='pt-10 hero-sec '>
       <div className="head flex flex-wrap items-center justify center mx-auto mt-10 md:px-12 md:flex-row">
        ...
        <div className="text-sec mb-14 lg:mb-10 lg:w-1/2">
            <h1 className="hd_txt max-w-xl text-[5rem] bold-xl leading-none mb-5">We create home more asthetic</h1>
